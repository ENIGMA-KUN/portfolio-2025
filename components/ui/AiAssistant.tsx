...
const presetResponses = {
  ...
  "aranya": "Aranya.io is a climate technology startup where Shubham worked as a Machine Learning Engineer. It provides a comprehensive platform for emissions management and climate scenario analysis. The platform includes:\n\n• Emissions calculation engine across all scopes\n• Scenario modeling for reduction pathways\n• Financial impact analysis for climate initiatives\n• AI-powered sustainability reporting\n\nShubham built the platform using Python, React, AWS, and machine learning components. The venture secured $100K in seed funding and served multiple enterprise clients. Aranya.io was later acquired by NPCI / Snapper Future Tech."
};
...
const AiAssistant = () => {
  ...
  const generateResponse = (query: string) => {
    ...
    if (query.includes('rag') || query.includes('assistant') || query.includes('retrieval')) {
      ...
      response = "The Emissions Reduction Platform is a comprehensive climate technology solution built by Shubham at Aranya.io. It enables organizations to track, analyze, and reduce their carbon footprint through sophisticated modeling and scenario analysis. The platform includes emissions calculation across all scopes, reduction pathways modeling, financial impact analysis, and AI-powered reporting capabilities.";
